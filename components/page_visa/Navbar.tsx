...
const Navbar = ({
  ...
  return (
    <div
      className={`w-full ${showBorder ? "md:border-b border-gray-300" : ""} ${
        transparent ? "bg-transparent" : "bg-white"
      } md:sticky md:top-0 z-[100] fixed bottom-0 flex min-w-[300px] h-fit ${className}`}
    >
      <div
        className={`${
          transparent ? "bg-transparent" : "bg-white"
        } flex max-w-[80rem] mx-auto justify-between items-center px-3 md:px-8 h-[4rem] md:h-20 w-full flex-shrink-0 border-t md:border-t-0 border-gray-300 `}
      >
